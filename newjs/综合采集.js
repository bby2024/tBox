const webSite = {
    "resources": [{
            "name": "豆瓣采集", // 源名称
            "url": "https://caiji.dbzy.tv/api.php/provide/vod/", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
        {
            "name": "虎牙采集", // 源名称
            "url": "https://www.huyaapi.com/api.php/provide/vod/", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
           {
            "name": "zq采集", // 源名称
            "url": "http://zhangqun1818.serv00.net/cjjh.php", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
       {
            "name": "天堂采集", // 源名称
            "url": "http://caiji.dyttzyapi.com/api.php/provide/vod/", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        }, 
        {
            "name": "华为采集", // 源名称
            "url": "https://huawei8.live/api.php/provide/vod/", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
         {
            "name": "天翼采集", // 源名称
            "url": "https://www.911ysw.top/tianyi.php/provide/vod/?", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
           {
            "name": "杏吧采集", // 源名称
            "url": "https://api.jmzy.com/api.php/provide/vod/", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
        {
        ...
        {
            "name": "光速资源", // 源名称
            "url": "http://api.guangsuapi.com/api.php/provide/vod/", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
        {
            "name": "极速资源", // 源名称
            "url": "https://jszyapi.com/api.php/provide/vod/", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
        {
            "name": "暴风资源", // 源名称
            "url": "https://bfzyapi.com/api.php/provide/vod/", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
        {
            "name": "虾米资源", // 源名称
            "url": "https://iqiyizyapi.com/api.php/provide/vod/", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
        {
            "name": "官采资源", // 源名称
            "url": "https://mfgc.iwsyy.xyz/api.php/provide/vod/?ac=list", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
        {
            "name": "听风资源", // 源名称
            "url": "https://www.qilinzyz.com/api.php/provide/vod/", // 源链接
            "filter_tags": ["演员"], // 过滤分类
            "prepend_classes": ["国产剧", "港台剧"] // 前置分类
        },
        {
